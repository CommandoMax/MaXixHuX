-- ========================================================================
-- MAXIX HUX V15.3 - TRUE ARSENAL (ULTIMATE EDITION COMPLÈTE)
-- ========================================================================
...
local Window = Fluent:CreateWindow({
    Title = "MaXix HuX", SubTitle = "V15.3 Ultimate Arsenal", 
...
local Tabs = {
    ...
    Objets = Window:AddTab({Title="Objets/Voitures", Icon="car"}), -- NOUVEAU
...
Tabs.Avatar:AddToggle("GodMode", {Title="God Mode (Boucle de Soin)", Default=false}):OnChanged(function(v) 
...
Window:SelectTab(1)
Fluent:Notify({Title = "MaXix HuX V15.3", Content = "Ultimate Edition 100% complète chargée !", Duration = 5})
